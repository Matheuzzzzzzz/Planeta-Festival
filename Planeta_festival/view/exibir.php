...
<head>
    ...
    <title>Locais</title>
    <link rel="stylesheet" href="../Components/css/exibircss.css">
                ...
                <li>
                    <div class="dropdown">
                        ...
                        <ul class="droplist">
                            ...
                            <li><a href="usuario.php">Página de Usuário</a></li>
                        </ul>
                    </div>
                </li>
                <li>
  ...
  background-color:hwb(227 0% 77%);  
    ...
    <footer class="pe">
        <div id="borda">
            ...
            <a href="../view/cadastroespaco.php" id="btnentrar" class="btn btn-primary">Cadastro</a>
        </div>
