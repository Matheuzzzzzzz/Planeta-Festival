...
<header>
  <nav>
    <ul class="listnav">
      ...
      <li>
        <h1><img id="astronalta" src="https://images.vexels.com/media/users/3/205157/isolated/preview/3a1d0d70d14ba68cd27271c889618e51-ilustracao-do-espaco-astronauta.png" alt="">Planeta Festival<a href="pag_inicial.php"></a></h1>
      </li>
...
<?php elseif (isset($resultadoUpdate)) : ?>
  <?php if ($resultadoUpdate) : ?>
    ...
    <a href="../view/cadastrocliente.php" class="btn btn-danger" class="atualiza">voltar</a>
  <?php else : ?>
